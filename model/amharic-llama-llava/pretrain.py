...
def main():
    ...
    # Remove these lines of code causing model saving bug!
    # These are in original hf code but prevent model from being saved
    #old_state_dict = model.state_dict
    #abf = input('this code causes saving bug')
    #assert False
    #model.state_dict = (
